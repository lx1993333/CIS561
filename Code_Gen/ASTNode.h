...
namespace AST {
    ...
    public:
        ...
        void json(std::ostream& out, AST_print_context& ctx) override;
        std::string return_type() override;
        virtual std::string BinOp_name() = 0;
    ...
    public:
        ...
        int eval(EvalContext& ctx) override;
        std::string return_type() override;
        std::string BinOp_name() override;
    ...
    public:
        ...
        explicit Method_call(ASTNode &caller, Ident &name, ASTNode &inputs_args) :caller_{caller}, name_{name}, inputs_args_{inputs_args} {};
        void json(std::ostream& out, AST_print_context& ctx) override;
        int eval(EvalContext& ctx) override;
        std::string return_type() override;
        };
